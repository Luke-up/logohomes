...
<main class="contact-page">
    <section class="get-in-touch">
        <section class="contact-details-map" aria-label="Contact details and map">
                    ...
                    <li>
                        <span class="contact-detail-icon" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                                <path d="M12 21s7-5.49 7-11a7 7 0 1 0-14 0c0 5.51 7 11 7 11Z" stroke="currentColor" stroke-width="2"/>
                                <circle cx="12" cy="10" r="2.5" stroke="currentColor" stroke-width="2"/>
                            </svg>
                        </span>
                        <span>
                            Corner Prima Drive and Osmond Streets, Helderberg Industrial Park<br>
                            Strand, Western Cape
                        </span>
                    </li>
                    <li>
                        ...
                        <span><a href="tel:+27218454606">+27 21 845 4606</a></span>
                    </li>
                    <li>
                        <span class="contact-detail-icon" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                        ...
                        <span><a href="mailto:logo@icon.co.za">logo@icon.co.za</a></span>
                    </li>
                    <li class="contact-social-row">
                        <a href="https://www.facebook.com/pages/Logo-Homes/882329498476445" target="_blank" rel="noopener noreferrer" aria-label="Visit Logo Homes on Facebook">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="18" height="18" viewBox="0 0 310 310">
                        ...
                        <a href="https://www.instagram.com/logohomesza/" target="_blank" rel="noopener noreferrer" aria-label="Visit Logo Homes on Instagram">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
            ...
            <div class="contact-map-panel">
                <iframe
                    title="Logo Homes location map"
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13211.944646480355!2d18.876936!3d-34.121104!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1dcdca4a59115fdf%3A0x9fc31a4f2182abae!2sLogo%20Homes!5e0!3m2!1sen!2sus!4v1776866750203!5m2!1sen!2sus"
                    width="600"
                    height="300"
                    style="border:0;"
                    loading="lazy"
